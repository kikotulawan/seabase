...
<script type="text/javascript">
  $(function () {
    ...
    $('.data-table').on('click', '.edit', function () {
      var id = $(this).data("id");
      $.get("{{ route('clinics.index') }}" +'/' + id +'/edit', function (data) {
