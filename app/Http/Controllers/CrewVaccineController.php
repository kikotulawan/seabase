...
use App\CrewVaccine;
use App\Http\Requests\CrewVaccineRequest;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Storage;

class CrewVaccineController extends Controller
{
    /**
    ...
    public function vaccine($id){
        ...
        if(!empty($output))
        {
            foreach ($output as $value)
            {
                ...
                $nestedData['immunization_date'] = $value->immunization_date;
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CrewVaccineRequest $request)
    {
        $data = $request->all();
        ...
        CrewVaccine::create($data);
        //$request->user()->crewvaccine()->create($data);
        return response()->json(['success'=>'New Vaccine has been added.']);
    }
    ...
    {
        return response()->json(CrewVaccine::find($id));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(CrewVaccineRequest $request)
    {
        $update=CrewVaccine::find($request->id);
    ...
    public function update_attachment(Request $request)
    {
        ...
        $update=CrewVaccine::find($request->id)->with('crew')->first();
